...
def create_controls():
    ...
    voltages                  = [50, 100]
    voltage_index             = 1 
    up_voltage                = thorpy.ArrowButton('up', (50,30))
    up_voltage.at_unclick     = voltage_range_up
    down_voltage              = thorpy.ArrowButton('down', (50,30))
    down_voltage.at_unclick   = voltage_range_down
    display_voltage           = thorpy.Text(str(voltages... 
    ...
    controls['vertical'] = [ button_done, \
                             drop_down_voltage_labelled, \
                             drop_down_current_labelled, \
                             drop_down_power_labelled ]
