...
def write_out():
    for acq in ring_buffer[out_ptr:BUFFER_SIZE]:
        1
    for acq in ring_buffer[0:in_ptr]:
        1
...
def main():
    ...
    while True:
        # indicate and print every circulation of the buffer
        ...
        if in_ptr == 0:
            ...
            # print the ADC value
            display_update(3, ring_buffer[in_ptr])
